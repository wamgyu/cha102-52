...
<nav class="navbar navbar-expand-md navbar-dark bg-success fixed-top justify-content-center">
	...
	<div align="center">
		...
		<span>部門:</span><span>${empVO.deptno}-[${empVO.deptVO.dname}]</span><br/>
		<span>照片:</span><span><img src="<%=request.getContextPath()%>/emp/DBGifReader?empno=${empVO.empno}" width="100px"></span><br/>
	</div>
