		...
		<form action="<%=request.getContextPath()%>/emp/emp.do" method="post"
			...
			<div>
				<label for="ename">員工姓名:</label>
				 <input id="ename" name="ename"type="text" value="${param.ename}" />
				<span id="ename.errors"class="error">${errorMsgs.ename}<br /></span>
			</div>

			<div>
				<label for="job">職位:</label> <input id="job" name="job" type="text"
					value="${param.job}" onclick="hideContent('job.errors');" /> <span
					id="job.errors" class="error">${errorMsgs.job}</span>
			</div>

			<div>
				<label for="hiredate">雇用日期:</label> <input id="hiredate"
			...
			<div>
				<label for="sal">薪水:</label> <input id="sal" name="sal" type="text"
					value="${param.sal}" onclick="hideContent('sal.errors');" /> <span
					id="sal.errors" class="error">${errorMsgs.sal}</span>
			</div>

			<div>
				<label for="comm">獎金:</label> <input id="comm" name="comm"
					type="text" value="${param.comm}"
					onclick="hideContent('comm.errors');" /> <span id="comm.errors"
					class="error">${errorMsgs.comm}</span>
			</div>

			<jsp:useBean id="deptSvc" scope="page"
				class="com.dept.model.DeptService" />
			<div>
				<label for="deptno">部門:</label> <select id="deptno" name="deptno">
			...
			<div>
				<label for="upFiles">照片:</label> <input id="upFiles" name="upFiles"
					type="file" onclick="previewImage()" multiple="multiple"
					onchange="hideContent('upFiles.errors');" /> <span
					id="upFiles.errors" class="error">${errorMsgs.upFiles}</span>
