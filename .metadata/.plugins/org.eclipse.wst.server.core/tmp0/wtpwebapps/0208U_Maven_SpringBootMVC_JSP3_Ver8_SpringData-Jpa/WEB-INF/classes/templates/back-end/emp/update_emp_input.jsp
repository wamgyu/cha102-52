...
<nav class="navbar navbar-expand-md navbar-dark bg-success fixed-top justify-content-center">
	...
	<div align="center">
		...
		<form:form action="update" method="post" modelAttribute="empVO" enctype="multipart/form-data">
			<div>
			<form:label  path="empno">員工編號:</form:label>
			<form:input  path="empno" cssStyle="border:0px ; font-weight: bold;" readonly="true"/>
			...
			<form:input  path="upFiles" type="file" onclick="previewImage()" multiple="multiple" />
            <%-- 可以不修改圖片 <form:errors path="upFiles" class="error" /> --%>
			<div id="blob_holder"><img src="<spring:url value='/emp/DBGifReader?empno=${empVO.empno}'/>" width="100px"></div>
			</div>

			<div>
				<div></div>
				<form:button id="submit"> 送出修改 </form:button>
				<div></div>
			</div>
		</form:form>
