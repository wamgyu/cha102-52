...
public class TableBookingImpl implements TableBookingDao{
    @Override
    public Integer insert(TableBookingVo tablebookingvo){
        getSession().persist(tablebookingvo);
        return 1;
    }
    @Override
    ...
    @Override
    public Integer update(TableBookingVo tableBookingVo) {
    ...
    public List<TableBookingVo> SelectByChoose(Date date, int tableno){
        ...
        Date startDate = java.sql.Date.valueOf(date.toLocalDate());
    ...
    public Integer test(TableBookingVo tableBookingVo){
        ...
        try{
            ...
            bookingListVo = session.get(BookingListVo.class, bookingListVo.getPeriodtime());

            //創建實體
             tableBookingVo = new TableBookingVo();
             tableBookingVo.setTablemor(bookingListVo.getPeriodtime());
